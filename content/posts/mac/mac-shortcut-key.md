...
date = "2025-01-13"
lastmod = "2025-01-13"
subtitle = "全局、窗口、访达、截图、浏览器、文本编辑一图速查"
description = "整理 macOS 日常高频快捷键，覆盖全局切换、剪切拷贝粘贴、窗口管理、访达操作、截图、浏览器和文本编辑，配合修饰键说明快速上手。"
author = "小智晖"
authors = ["小智晖"]
categories = ["mac", "效率"]
tags = ["mac", "macOS", "快捷键", "键盘", "效率", "访达"]
keywords = ["macOS 快捷键", "Mac 键盘快捷键", "访达快捷键", "macOS 截图快捷键", "Mac 文本编辑快捷键", "Command 键"]
toc = true
draft = false
+++
