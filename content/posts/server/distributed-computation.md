...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "BOINC 服务端搭建、AppVersion 配置与任务调度原理"
description = "介绍 BOINC 分布式计算平台的服务端部署、项目与 App 创建、任务提交流程,以及 feeder、transitioner、validator、assimilator 等核心守护进程的工作原理与调度实现。"
author = "小智晖"
authors = ["小智晖"]
categories = ["server", "分布式计算"]
tags = ["server", "boinc", "分布式计算", "志愿计算"]
keywords = ["BOINC", "分布式计算", "志愿计算", "任务调度", "AppVersion", "守护进程"]
toc = true
draft = false
+++
