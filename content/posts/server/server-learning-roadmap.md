...
date = "2025-09-14"
lastmod = "2025-09-14"
subtitle = "从系统设计到服务治理的后台开发知识图谱"
description = "梳理后台服务开发的核心概念：系统设计原则、架构词汇（集群、缓存、CAP/BASE）、服务异常与治理、网络通信和常见运维手段，附学习资料。"
author = "小智晖"
authors = ["小智晖"]
categories = ["后端开发", "server"]
tags = ["server", "roadmap", "系统设计", "分布式", "服务治理"]
keywords = ["server学习路线", "后台开发", "系统设计", "分布式架构", "CAP理论", "服务治理"]
toc = true
draft = false
+++
