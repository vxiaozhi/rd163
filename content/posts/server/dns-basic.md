...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "记录类型、解析流程与系统 DNS 解析器原理"
description = "梳理 DNS 的记录类型、递归与迭代解析、域名分层结构，以及操作系统 DNS 解析器（/etc/resolv.conf、搜索域、HTTPDNS）的工作机制与诊断工具。"
author = "小智晖"
authors = ["小智晖"]
categories = ["server"]
tags = ["server", "dns", "network", "kubernetes", "httpdns"]
keywords = ["DNS", "DNS 记录类型", "递归查询", "FQDN", "resolv.conf", "HTTPDNS"]
toc = true
draft = false
+++
