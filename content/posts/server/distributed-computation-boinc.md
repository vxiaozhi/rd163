...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "BOINC 平台的 App 定义、部署实践与服务端/客户端调试方法论"
description = "记录 BOINC 分布式计算平台的核心概念、App 与 Wrapper 部署流程，以及任务调度失败、资源不足等常见问题的服务端/客户端调试方法。"
author = "小智晖"
authors = ["小智晖"]
categories = ["server", "分布式计算"]
tags = ["server", "boinc", "分布式计算", "志愿计算", "BOINC"]
keywords = ["BOINC", "分布式计算", "志愿计算", "Boinc 部署", "Boinc 调试"]
toc = true
draft = false
+++
