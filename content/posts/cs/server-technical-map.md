...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "后端架构师全景技术图谱"
description = "系统梳理后端架构师所需的技术图谱,涵盖数据结构、常用算法、并发、操作系统、网络、数据库、分布式、架构设计、运维、安全等各大领域的主题与参考资料。"
author = "小智晖"
authors = ["小智晖"]
categories = ["cs"]
tags = ["cs", "后端", "架构", "技术图谱", "后台开发"]
keywords = ["后端技术图谱", "后台架构师", "数据结构", "分布式", "系统设计", "技术路线图"]
toc = true
draft = false
+++
