...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "从 kube-dns 到 CoreDNS:搜索域、DNS 策略、Corefile 配置与源码分析"
description = "Kubernetes 集群内 DNS 解析机制详解,覆盖 resolv.conf 搜索域、Service/Pod DNS 记录、四种 dnsPolicy、dnsConfig 自定义、CoreDNS Corefile 配置以及 kubelet 源码实现。"
author = "小智晖"
authors = ["小智晖"]
categories = ["k8s"]
tags = ["k8s", "coredns", "dns", "kubernetes"]
keywords = ["kubernetes", "coredns", "kube-dns", "dnsPolicy", "dnsConfig", "resolv.conf"]
toc = true
draft = false
+++
