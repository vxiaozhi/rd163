...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "服务网格的概念、主流产品与架构演进"
description = "介绍服务网格（Service Mesh）的概念、特点与架构演进，对比 Linkerd、Istio、Kuma、SOFAMesh 等主流产品，理清控制平面与数据平面的职责划分。"
author = "小智晖"
authors = ["小智晖"]
categories = ["k8s", "服务网格"]
tags = ["k8s", "service-mesh", "istio", "envoy", "sidecar"]
keywords = ["Service Mesh", "服务网格", "Istio", "Linkerd", "Envoy", "Sidecar"]
toc = true
draft = false
+++
