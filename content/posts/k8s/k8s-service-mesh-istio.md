...
date = "2025-01-12"
lastmod = "2025-01-12"
subtitle = "Istio 架构、Sidecar 注入与流量劫持原理深度解析"
description = "系统介绍 Kubernetes 服务网格（Service Mesh）的概念、架构与工作流程，并基于 Istio 深入解析 Envoy Sidecar 注入、iptables 流量劫持与路由转发机制。"
author = "小智晖"
authors = ["小智晖"]
categories = ["k8s", "服务网格"]
tags = ["k8s", "服务网格", "Istio", "Service Mesh", "Envoy", "Sidecar"]
keywords = ["服务网格", "Service Mesh", "Istio", "Envoy", "Sidecar", "流量劫持"]
toc = true
draft = false
+++
