...
date = "2025-06-07"
lastmod = "2025-06-07"
subtitle = "国人开发的全栈 MVC Web 框架与组件体系"
description = "介绍 Go 语言 Web 框架 Beego 的核心特性、MVC 架构、ORM、路由、过滤器及热编译、i18n、安全防护等高级功能,并结合 Casdoor 等开源项目说明实际应用。"
author = "小智晖"
authors = ["小智晖"]
categories = ["golang"]
tags = ["编程语言", "golang", "webframework", "beego", "MVC", "ORM"]
keywords = ["golang", "beego", "web 框架", "MVC", "ORM", "bee 工具"]
toc = true
draft = false
+++
